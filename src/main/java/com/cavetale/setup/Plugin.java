...
public enum Plugin implements PluginSet {
    ...
    DUNGEONS("Dungeons", "com.cavetale.dungeons", "dungeons", "0.1-SNAPSHOT", Category.HOME),
    ...
    EXTREME_GRASS_GROWING("ExtremeGrassGrowing", "com.cavetale.extremegrassgrowing", "extremegrassgrowing", "0.1-SNAPSHOT", Category.MINIGAME),
    ...
    KING_OF_THE_LADDER("KingOfTheLadder", "com.cavetale.kotl", "kotl", "0.1-SNAPSHOT", Category.MINIGAME),
    ...
    STRUCTURE("Structure", "com.cavetale.structure", "structure", "0.1-SNAPSHOT", Category.HOME),
