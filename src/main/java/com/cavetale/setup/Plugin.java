...
public enum Plugin implements PluginSet {
    ...
    DUNGEONS("Dungeons", "com.cavetale.dungeons", "dungeons", "0.1-SNAPSHOT", Category.MAIN),
    ...
    EXTREME_GRASS_GROWING("ExtremeGrassGrowing", "com.cavetale.extremegrassgrowing", "extremegrassgrowing", "0.1-SNAPSHOT", Category.MAIN),
    ...
    KING_OF_THE_LADDER("KingOfTheLadder", "com.cavetale.kotl", "kotl", "0.1-SNAPSHOT", Category.MAIN),
    ...
    NU_VOTIFIER("NuVotifier", (URL) null, Category.MAIN),
